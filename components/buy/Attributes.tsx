...
<h2 className='text-3xl font-extrabold text-center bg_gr text-transparent bg-clip-text tracking-[1px] uppercase'>Attributes</h2>
<p className='text-sm text-center'>UPON MINTING ULTRA RARE NFTS ARE GIVEN 4 OF 5 RANDOM ATTRIBUTES THAT HAVE A RANDOM POWER SCALE FROM 1-100.
        ...
        <tbody className=''>
       {
        ATTRIBUTES.map((el,indx)=>{
            return (
                ...
                <td className='bg-[#262C33] py-2 px-2' ><p>{el.name}</p></td>
...
<div className='flex flex-row items-center gap-3 m-auto'>
    ...
    <p><a  className='text-[#1C84FE] uppercase' href="http://" target="_blank" rel="noreferrer">
        About</a></p>
</div>
